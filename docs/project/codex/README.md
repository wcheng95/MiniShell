...
```text
T010-adv-audio-tx-timeout.md   READY
```
...
Workflow: local build/test + ADV firmware build -> pushed commit -> supervisor diff review -> ADV hardware probe -> acceptance/merge -> delete T010 branch.
