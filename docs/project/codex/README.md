...
Workflow: static capture + ADV freq_osr=1 reviewed PASS -> stable live runtime confirmed -> verify UAC stream/timing -> obtain live decodes/ring stats -> acceptance/merge -> delete T017 branch.
