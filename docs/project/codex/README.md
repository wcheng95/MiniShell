...
Workflow: implement authorized USB PHY + GPIO4/5 debug-console amendment -> re-run Linux/unit/ADV build -> supervisor re-review -> QMX live hardware validation -> acceptance/merge -> delete T017 branch.
