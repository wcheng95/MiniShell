...
```text
T017-adv-usb-uac-rx.md   BLOCKED
```
...
Workflow: supervisor review found USB PHY ownership blocker -> amend console handoff -> re-run Linux/unit/ADV build -> supervisor re-review -> QMX live hardware validation -> acceptance/merge -> delete T017 branch.
