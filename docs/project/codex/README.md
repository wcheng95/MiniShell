...
Workflow: QMX-connected run returns immediately after UAC install -> make uac_capture task static + add creation breadcrumb -> re-run gates -> supervisor re-review -> resume QMX enumeration/live RX validation -> acceptance/merge -> delete T017 branch.
