...
T046 Mini-CW callsign lookup     COMPLETE — full V1.2 callsign table loads through MiniShell Memory with no truncation; ADV hardware lookup/audio/header/clearing/exit accepted
