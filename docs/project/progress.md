...
- T078 is TESTING: shared eager pathname auto-expansion is implemented with a paste-safe 25 ms idle debounce, public Filesystem-only matching, longest-common-prefix growth, and no command/app completion. Software review passed after the paste-safety correction; corrected-build pc-1 validation and a short ADV regression check remain.
