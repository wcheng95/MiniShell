...
- T036 is TESTING: ADV MiniFT8 mirror passed software/build review. WebFS remains separate; the mirror exposes only the exact 20x7 presented display plus normal key-event injection. Hardware MAKE/BREAK validation of concurrent Wi-Fi/HTTP + live QMX/FT8 RX is pending.
...
T036         TESTING — ADV MiniFT8 mirrored web front panel, MAKE/BREAK pending
