...
T048 Mini-CW transcript log      REVIEW — hardware logging/note mode works; fold in one-byte bound fix, whitespace-aware truncation, and exactly-spaced **note** tokens
