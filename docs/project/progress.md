...
T048 Mini-CW transcript log      READY — compact HHMM minute transcript, 1024-byte buffer, daily /flash/minicw/YYYYMMDD.txt, no G records, ' / " safe note mode with **note** delimiters
