...
- T078 is READY for correction: eager/idle pathname rewriting was not accepted. Final trigger is explicit Tab only; typing and paste remain literal. The shared longest-common-prefix matcher and pathname eligibility policy remain, while the 25 ms debounce/pending machinery is to be removed. T079 remains reserved for showing ambiguous pathname choices after Tab cannot grow the prefix further.
